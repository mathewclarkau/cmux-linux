...
assemble_prompt() {
...

  {
    ...
    echo "- This is a temporary output directory. The harness swaps it into mux/bindings/$lang/ only after generation succeeds."
    ...
    echo "- Implement protocol-v5 commands marked implemented, plus consumer-side implemented move commands."
...
for lang in "${STUB_LANGS[@]}"; do
  ...
  echo "Skipping $lang generation this round; style sheet is present at mux/bindings/styles/$lang.md"
done
