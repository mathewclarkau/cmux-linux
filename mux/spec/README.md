# mtyx Programmability Contract

This directory is the source of truth for the mtyx control protocol, the generated `mtyx` command surface, and future generated language bindings. The implemented protocol described here is protocol version 5, as defined by `mux-core/src/server.rs`.
...
| `cli.md`        | Generated `mtyx <verb>` conventions, exit codes, stdin rules, verb table, and examples |
